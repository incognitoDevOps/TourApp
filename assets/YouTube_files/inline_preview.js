(function(g){var window=this;'use strict';var Qsb=function(a){g.V.call(this,{I:"div",S:"ytp-inline-preview-ui"});this.C=!1;this.player=a;this.T(a,"onStateChange",this.z2);this.T(a,"videodatachange",this.A2);this.T(a,"onInlinePreviewModeChange",this.b8);this.B=new g.Ou(this.v2,null,this);g.N(this,this.B)},J6=function(a){g.OV.call(this,a);
this.j=new Qsb(this.player);g.N(this,this.j);this.j.hide();g.zU(this.player,this.j.element,4);a.isInline()&&(this.load(),a=a.getRootNode(),g.Zu(a,["ytp-inline-preview-mode","ytp-no-contextmenu"]))};
g.w(Qsb,g.V);g.k=Qsb.prototype;
