...
const dummyNewsData = [
  {
    ...
    describe: "Discover the latest tourist attraction in Nyamira.",
  ...
  },
  {
    ...
    describe: "Get valuable tips to make your travel experience unforgettable.",
...
const dummyFeaturesData = [
  {
    ...
    county: "Narok",
    country: "Kenya",
    description: "Discover the latest tourist attraction in Masai Mara.",
  ...
  return (
    <ScrollView>
      <View>
        ...
        <Image
          source={require("../assets/kit-mikayi-poster.jpg")}
          style={{ width: "100%", height: 200, resizeMode: "cover" }}
        />

        {/* Featured Destinations: */}
        <Text style={{ fontWeight: 800, padding: 15, fontSize: 18 }}>
          ...
          {dummyFeaturesData.map((item) => (
            <TouchableOpacity onPress={() => navigateToTrendingScreen(item)}>
              ...
              >
                ...
                />
                <View>
                  <Text style={{ margin: 8, fontWeight: 500 }}>
